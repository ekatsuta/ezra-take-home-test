...
describe('date utils', () => {
  describe('formatDate', () => {
    it('should format date string to localized date', () => {
      const inputDate = '2024-02-23T10:00:00Z';
      const result = formatDate(inputDate);

      // Compare against what the same date would produce
      const expected = new Date(inputDate).toLocaleDateString();
    ...
    it('should handle different date formats', () => {
      const inputDate = '2024-12-31T23:59:59Z';
      const result = formatDate(inputDate);
  ...
  describe('formatDateForInput', () => {
    it('should format date string to YYYY-MM-DD format', () => {
      const result = formatDateForInput('2024-02-23T10:00:00Z');
    ...
    it('should handle dates at end of year', () => {
      const result = formatDateForInput('2024-12-31T23:59:59Z');
  ...
  describe('getTodayDate', () => {
    ...
    it('should return today date in YYYY-MM-DD format', () => {
      const mockDate = new Date('2024-02-23T15:30:00Z');
  ...
  describe('convertDateToISO', () => {
    it('should convert YYYY-MM-DD to ISO datetime format', () => {
      const result = convertDateToISO('2024-02-23');
      expect(result).toBe('2024-02-23T00:00:00');
    });
